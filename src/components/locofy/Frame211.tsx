import svgPaths from "../svg/svg-cr0xekudny";
...
function Frame3() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col gap-[20px] h-[734px] items-start left-[17px] overflow-x-clip overflow-y-auto p-[12px] rounded-[20px] top-[19px] w-[749px]">
      <About />
      <DivInfoNote />
      <Frame6 />
      <DivFormGroup />
