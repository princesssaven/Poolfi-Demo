import svgPaths from "../svg/svg-np4y0s53l6";
...
function Frame1() {
  return (
    <div className="absolute content-stretch flex gap-[608px] items-center left-[32px] p-[12px] top-[12px] w-[1149px]">
      <Container />
      <Frame8 />
    </div>
  );
  ...
  return (
    <div className="h-[31px] relative shrink-0 w-full" data-name="div.tabs">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start overflow-auto pb-px relative size-full">
        ...
        <div className="bg-[#eef3ff] relative self-stretch shrink-0" data-name="Component 5">
    ...
    <div className="flex-[1_0_0] min-w-px relative" data-name="div#placeholder">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <div className="flex flex-col font-['DM_Sans:9pt_Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#c4c9d4] text-[14px] w-full" style={{ fontVariationSettings: "'opsz' 9" }}>
          <p className="leading-[22.4px] mb-0">Share what’s happening with the project- progress, photos, milestones.</p>
          <p className="leading-[22.4px]">Contributors will be notified</p>
        </div>
      </div>
    </div>
  );
...
function TextareaPoolDesc() {
  return (
    <div className="absolute bg-white h-[123px] left-[56px] min-h-[80px] right-[57px] rounded-[10px] top-[46px]" data-name="textarea#pool-desc">
      <div className="content-stretch flex items-start justify-center min-h-[inherit] overflow-auto pb-[45.61px] pt-[12px] px-[15px] relative size-full">
        <DivPlaceholder />
      </div>
      <div aria-hidden="true" className="absolute border border-[#e5e8ef] border-solid inset-0 pointer-events-none rounded-[10px]" />
    </div>
...
function Album() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="album-02">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="album-02">
          <path d={svgPaths.pa33700} id="Vector" stroke="var(--stroke-0, #1B4FD8)" strokeWidth="1.5" />
          <path d={svgPaths.p32c1e580} id="Vector_2" stroke="var(--stroke-0, #1B4FD8)" strokeWidth="1.5" />
          <path d={svgPaths.p32c220d0} id="Vector_3" stroke="var(--stroke-0, #1B4FD8)" strokeLinejoin="round" strokeWidth="1.5" />
          <path d="M12.9998 7H13.0088" id="Vector_4" stroke="var(--stroke-0, #1B4FD8)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
...
function Component() {
  return (
    <div className="bg-white content-stretch flex gap-[6px] items-center justify-center px-[14px] py-[9px] relative rounded-[9px] shrink-0" data-name="Component 2">
      <Album />
      <div className="flex flex-col font-['DM_Sans:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#6b7280] text-[12px] text-center whitespace-nowrap" style={{ fontVariationSettings: "'opsz' 14" }}>
        <p className="leading-[normal]">Attach Photo</p>
      </div>
    </div>
  );
}
...
function Frame10() {
  return (
    <div className="content-stretch flex gap-[31px] items-center relative shrink-0 w-[370px]">
      <Component />
      <div className="bg-white content-stretch flex flex-col items-center justify-center px-[14px] py-[9px] relative rounded-[9px] shrink-0" data-name="Component 3">
        <div className="flex flex-col font-['DM_Sans:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#065f46] text-[12px] text-center whitespace-nowrap" style={{ fontVariationSettings: "'opsz' 14" }}>
          <p>
            <span className="leading-[normal]">{` `}</span>
            <span className="leading-[normal] text-[#6b7280]">Documents</span>
          </p>
        </div>
      </div>
    </div>
...
function Frame6() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full">
      <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[13.047px] text-white whitespace-nowrap">
        <p className="leading-[17px]">Post Updates →</p>
      </div>
    </div>
  );
}

function ButtonBackgroundColor1() {
  return (
    <div className="bg-[#1b4fd8] content-stretch flex flex-col h-[33px] items-center justify-center px-[5px] py-[4px] relative rounded-[9px] shrink-0 w-[111px]" data-name="Button+BackgroundColor">
      <Frame6 />
    </div>
  );
}
...
function Frame9() {
  return (
    <div className="absolute content-stretch flex gap-[172px] items-center left-[71px] top-[180px]">
      <Frame10 />
...
function Frame4() {
  return (
    <div className="bg-[#f4f5f7] h-[236px] relative rounded-[12px] shrink-0 w-full">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <DivFormCardTitle />
        <div className="-translate-y-1/2 absolute flex flex-col font-['Sora:Bold',sans-serif] font-bold justify-center leading-[0] left-[56px] text-[#1a1f2e] text-[17px] top-[24.5px] tracking-[-0.3px] w-[250px]">
          <p className="leading-[normal]">Post a new update</p>
        </div>
        <TextareaPoolDesc />
        <Frame9 />
      </div>
...
function Div() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[128px]" data-name="div">
      <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Component 4">
        <div className="flex flex-col font-['DM_Sans:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#1a1f2e] text-[13px] whitespace-nowrap" style={{ fontVariationSettings: "'opsz' 14" }}>
          <p className="leading-[normal]">Princess Saven</p>
        </div>
      </div>
      <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Component 4">
...
function SpanStatusChip() {
  return (
    <div className="bg-[#f4f5f7] content-stretch flex items-start px-[10px] py-[3px] relative rounded-[100px] shrink-0" data-name="span.status-chip">
      <div className="flex flex-col font-['DM_Sans:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#12b76a] text-[11px] whitespace-nowrap" style={{ fontVariationSettings: "'opsz' 14" }}>
        <p className="leading-[normal]">You · Creator</p>
      </div>
    </div>
  );
}
...
function Frame15() {
  return (
    <div className="content-stretch flex gap-[28px] items-center justify-center relative shrink-0">
      <Frame11 />
      <SpanStatusChip />
    </div>
  );
...
function Frame12() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[12px] items-start left-[12px] p-[8px] top-[13px] w-[730px]">
      <Frame15 />
      <div className="flex flex-col font-['DM_Sans:9pt_Regular','Noto_Sans:Regular',sans-serif] font-normal justify-center leading-[0] min-w-full relative shrink-0 text-[#6b7280] text-[14px] w-[min-content]" style={{ fontVariationSettings: "'opsz' 9" }}>
        <p className="leading-[22.4px]">Drilling began yesterday! The AquaTech team arrived and the first 20 metres are complete. We expect to hit the water table by this weekend. The ₦200,000 first withdrawal was used entirely for mobilisation and equipment transport as approved by contributors.</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0">
      <div className="flex flex-col justify-center relative shrink-0" style={{ fontVariationSettings: "'opsz' 9" }}>
        <p className="leading-[22.4px]">❤️142reactions</p>
      </div>
      <div className="flex flex-col justify-center relative shrink-0" style={{ fontVariationSettings: "'opsz' 9" }}>
        <p className="leading-[22.4px]">👁️289views</p>
      </div>
    </div>
  );
}
...
function Frame13() {
  return (
    <div className="absolute content-stretch flex font-['DM_Sans:9pt_Regular',sans-serif] font-normal gap-[10px] items-center justify-center leading-[0] left-[24.98px] p-[10px] text-[14px] text-black top-[142px] whitespace-nowrap">
      <Frame14 />
      <div className="flex flex-col justify-center relative shrink-0" style={{ fontVariationSettings: "'opsz' 9" }}>
        <p className="leading-[22.4px]">💬14comments</p>
      </div>
    </div>
  );
}
...
function Td() {
  return (
    <div className="h-[185px] relative shrink-0 w-[796px]" data-name="td">
      <div aria-hidden="true" className="absolute border-[#e5e8ef] border-b border-solid inset-0 pointer-events-none" />
      <Frame12 />
      <Frame13 />
    </div>
...
function Frame16() {
  return (
    <div className="relative shrink-0 w-[730px]">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[12px] items-start p-[8px] relative size-full">
        <Frame17 />
        <div className="flex flex-col font-['DM_Sans:9pt_Regular','Noto_Sans:Regular',sans-serif] font-normal justify-center leading-[0] min-w-full relative shrink-0 text-[#6b7280] text-[14px] w-[min-content]" style={{ fontVariationSettings: "'opsz' 9" }}>
          <p className="leading-[22.4px]">{`We've reached 60% of our target and signed the contract with AquaTech NG. The first withdrawal of ₦200,000 has been approved by contributors and released. Work begins Feb 14th.`}</p>
        </div>
      </div>
    </div>
  );
...
function Frame19() {
  return (
    <div className="relative shrink-0">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex font-['DM_Sans:9pt_Regular',sans-serif] font-normal gap-[10px] items-center justify-center leading-[0] p-[10px] relative size-full text-[14px] text-black whitespace-nowrap">
        <Frame20 />
        <div className="flex flex-col justify-center relative shrink-0" style={{ fontVariationSettings: "'opsz' 9" }}>
          <p className="leading-[22.4px]">💬14comments</p>
        </div>
...
function Td1() {
  return (
    <div className="relative shrink-0 w-full" data-name="td">
      <div aria-hidden="true" className="absolute border-[#e5e8ef] border-b border-solid inset-0 pointer-events-none" />
      <div className="content-stretch flex flex-col gap-[8px] items-start pb-px px-[12px] relative size-full">
        <Frame16 />
        <Frame19 />
      </div>
    </div>
...
function DivTabsWrap() {
  return (
    <div className="bg-white relative rounded-[16px] shrink-0 w-[798px]" data-name="div.tabs-wrap">
...
export default function Updates() {
  return (
    <div className="bg-white relative size-full" data-name="Updates">
