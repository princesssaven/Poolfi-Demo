import svgPaths from "./svg-wmggaxp918";
...
function Frame1() {
  return (
    <div className="absolute content-stretch flex gap-[607px] items-center left-[32px] p-[12px] top-[12px] w-[1149px]">
      <Container />
      <Frame7 />
    </div>
  );
  ...
  return (
    <div className="h-[31px] relative shrink-0 w-full" data-name="div.tabs">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start overflow-auto pb-px relative size-full">
        ...
        <div className="bg-[#eef3ff] relative self-stretch shrink-0" data-name="Component 6">
...
function DivMultisigTitle() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="div.multisig-title">
      <div className="flex flex-col font-['DM_Sans:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#1b4fd8] text-[13px] whitespace-nowrap" style={{ fontVariationSettings: "'opsz' 14" }}>
        <p className="leading-[normal]">Request #2 - Solar pump installation</p>
      </div>
    </div>
  );
}
...
function Frame8() {
  return (
    <div className="content-stretch flex gap-[7px] items-center relative shrink-0 w-[427px]">
      <Span2 />
      <DivMultisigTitle />
    </div>
  );
  ...
  return (
    <div className="bg-[#f4f5f7] content-stretch flex items-start px-[10px] py-[3px] relative rounded-[100px] shrink-0" data-name="span.status-chip">
      <div className="flex flex-col font-['DM_Sans:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#fcd34d] text-[11px] whitespace-nowrap" style={{ fontVariationSettings: "'opsz' 14" }}>
        <p className="leading-[normal]">Awaiting Approval</p>
      </div>
    </div>
  );
}
...
function DivMultisigHeader() {
  return (
    <div className="relative shrink-0 w-full" data-name="div.multisig-header">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[213px] items-center relative size-full">
        <Frame8 />
        <SpanStatusChip />
      </div>
    </div>
...
function Div() {
  return (
    <div className="relative shrink-0 w-[762px]" data-name="div">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <div className="flex flex-col font-['Sora:ExtraBold','Noto_Sans:Black',sans-serif] font-extrabold justify-center leading-[0] relative shrink-0 text-[#1b4fd8] text-[28px] tracking-[-1px] whitespace-nowrap">
...
function DivApproverTrack() {
  return (
    <div className="relative shrink-0 w-[762px]" data-name="div.approver-track">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[6px] items-start justify-center relative size-full">
...
function MultisigInfo() {
  return (
    <div className="bg-[#eef3ff] relative rounded-[14px] shrink-0 w-[796px]" data-name="MULTISIG INFO">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[9.4px] items-start p-[17px] relative size-full">
        <DivMultisigHeader />
        <Div />
        <DivApproverTrack />
        <div className="relative shrink-0 w-[762px]" data-name="Component 4">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
            <div className="flex flex-col font-['DM_Sans:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#1b4fd8] text-[12px] whitespace-nowrap" style={{ fontVariationSettings: "'opsz' 14" }}>
              <p className="leading-[normal]">2 approved . 1 pending . 2 awaiting</p>
            </div>
          </div>
        </div>
      </div>
...
function DivTabsWrap() {
  return (
    <div className="bg-white relative rounded-[16px] shrink-0" data-name="div.tabs-wrap">
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="div.multisig-title">
      <div className="flex flex-col font-['DM_Sans:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#1a1f2e] text-[13px] whitespace-nowrap" style={{ fontVariationSettings: "'opsz' 14" }}>
        <p className="leading-[normal]">Withdrawal History</p>
      </div>
    </div>
  );
}
...
function DivMultisigTitle2() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="div.multisig-title">
      <div className="flex flex-col font-['DM_Sans:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#1a1f2e] text-[13px] whitespace-nowrap" style={{ fontVariationSettings: "'opsz' 14" }}>
        <p className="leading-[normal]">Request #1 - Site Mobilization</p>
      </div>
    </div>
  );
}
...
function Frame9() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start p-[8px] relative shrink-0 w-[485px]">
      <Frame10 />
      <div className="flex flex-col font-['DM_Sans:9pt_Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#6b7280] text-[14px] w-full" style={{ fontVariationSettings: "'opsz' 9" }}>
        <p className="leading-[22.4px]">Approved Feb 4, 2026 · 3 of 5 approvers</p>
      </div>
    </div>
  );
}
...
function Frame13() {
  return (
    <div className="content-stretch flex flex-col gap-[2px] items-center p-[8px] relative shrink-0 w-[143px]">
      <div className="flex flex-col font-['Sora:ExtraBold','Noto_Sans:Black',sans-serif] font-extrabold justify-center leading-[0] relative shrink-0 text-[#12b76a] text-[28px] tracking-[-1px] w-[143px]">
...
function Frame11() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute content-stretch flex gap-[94px] items-center left-1/2 top-[calc(50%-0.2px)]">
      <Frame9 />
      <Frame13 />
    </div>
  );
...
function Frame4() {
  return (
    <div className="bg-[#f4f5f7] h-[93px] relative rounded-[12px] shrink-0 w-full">
      <Frame11 />
    </div>
  );
}
...
function Component() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[19px] right-[65px] top-[45.8px]" data-name="Component 4">
      <div className="flex flex-col font-['DM_Sans:9pt_Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#5b21b6] text-[13px] w-[748px]" style={{ fontVariationSettings: "'opsz' 9" }}>
        <p className="leading-[normal]">Submit a withdrawal request with a clear purpose and supporting evidence. PoolFi will randomly select contributors to review and approve.</p>
      </div>
    </div>
  );
}
...
function WithdrawalStatus() {
  return (
    <div className="bg-[#f5f3ff] h-[157px] relative rounded-[14px] shrink-0 w-full" data-name="WITHDRAWAL STATUS">
      <div aria-hidden="true" className="absolute border border-[rgba(124,58,237,0.2)] border-solid inset-0 pointer-events-none rounded-[14px]" />
      <div className="absolute content-stretch flex items-center left-[19px] right-[19px] top-[17px]" data-name="Component 4">
        <div className="flex flex-col font-['DM_Sans:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#7c3aed] text-[13px] whitespace-nowrap" style={{ fontVariationSettings: "'opsz' 14" }}>
          <p className="leading-[normal]">🔐Request a New Withdrawal</p>
        </div>
      </div>
      <Component />
      <div className="absolute bg-[#7c3aed] content-stretch flex h-[48px] items-center justify-center left-[71px] p-[14px] rounded-[12px] top-[91.8px] w-[609px]" data-name="Component 2">
        <div className="flex flex-col font-['DM_Sans:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[15px] text-center text-white tracking-[-0.2px] whitespace-nowrap" style={{ fontVariationSettings: "'opsz' 14" }}>
          <p className="leading-[normal]">Submit Withdrawal Request</p>
        </div>
      </div>
    </div>
  );
...
function LeftTabs() {
  return (
    <div className="content-stretch flex flex-col gap-[14px] items-start pb-[20px] relative shrink-0" data-name="LEFT: TABS">
      <DivTabsWrap />
      <Frame12 />
      <WithdrawalStatus />
    </div>
